...
useEffect(() => {
  ...
  return (
   ...
   <Grid item xs={12} >
   <Box mx={'auto'}  >
    <Typography fontSize={'25px'} variant='h6' fontWeight={900} textAlign={'center'} >خوش آمدید، لطفا شرکت مورد نظر خود را انتخاب کنید</Typography>
   </Box>
   </Grid>
   ...
   <Box textAlign={'center'} py={2}  >
    ...
    variant='button'>در صورت تمایل بعدا هم میتوانید از طریق پروفایل کاربری،  شرکت خود را تغییر دهید.
    </Typography>
   </Box>
   </Grid>
