...
import { useGetDashBoardDataByyTenantId
 } from './Hooks/index';
import {Grid,Box,Typography} from '@mui/material';
import Tabs from '@mui/material/Tabs';
import Tab from '@mui/material/Tab';
import AllOkRs from './LComponents/AllTenantDash/AllTenantDash';
...
const Index :React.FC=function(){
  ...
  const[periodId,setPeriodId]=useState<string|null>(null);
  const[setDashBoard,setAllDashBoard]=useState<any[]>();
  const{data:dashBoardData,isLoading:getObjectiveLoading}
  =useGetDashBoardDataByyTenantId(periodId,tenantId)
