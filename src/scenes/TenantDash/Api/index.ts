...
// دریافت دوره ها
// https://api.myokr.ir/api/OKR/GetAllObjectiveByPeriodId/?tenantId=3f2d72cf-cdff-413c-abcd-d5459d97890c&periodId=d3fe4f1c-e2ce-470e-9e48-87ffb411a997&pageIndex=1&pageSize=5&searchTerm=
const getMyKeyResultByTenantId=async({queryKey}:any)=>{
    // profileTenantId
    let periodId=queryKey[1];
    let profileTenantId=queryKey[2];
    return await axiosInstance.get(`/OKR/GetMyKeyResultByTenantId/?tenantId=${profileTenantId}&periodId=${periodId}&pageIndex=1&pageSize=50&searchTerm=`)
}

const getMyMeetingByTenantId=async({queryKey}:any)=>{
    // profileTenantId
    let periodId=queryKey[1];
    let profileTenantId=queryKey[2];
    return await axiosInstance.get(`/OKR/GetMyMeetingByTenantId/?tenantId=${profileTenantId}&periodId=${periodId}&pageIndex=1&pageSize=50&searchTerm=`)
}

const getDashBoardDataByTenantId=async({queryKey}:any)=>{
    // profileTenantId
    let periodId=queryKey[1];
    let profileTenantId=queryKey[2];
    return await axiosInstance.get(`/OKR/GetDashBoardDataByTenantId/?tenantId=${profileTenantId}&periodId=${periodId}&pageIndex=1&pageSize=50&searchTerm=`)
}

const getMyObjectiveByTenantId=async({queryKey}:any)=>{
    // profileTenantId
    let periodId=queryKey[1];
    let profileTenantId=queryKey[2];
    return await axiosInstance.get(`/OKR/GetMyObjectiveByTenantId/?tenantId=${profileTenantId}&periodId=${periodId}&pageIndex=1&pageSize=50&searchTerm=`)
}
